...
namespace EHRS.Shared 
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public EHRSValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, EHRSValidationResult validationResult)
        {
            this.Data = data;
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(EHRSValidationResult validationResult)
        {
